                    ...
                    <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                      ...
                      <form className="mx-1 mx-md-4">
                        <div className="d-flex flex-row align-items-center mb-4">
                          <FontAwesomeIcon icon="fas fa-user " className='fa-lg fa-fw me-3'/>
                        ...
                        <div className="d-flex flex-row align-items-center mb-4">
                          <FontAwesomeIcon icon='fas fa-envelope' className=" fa-lg me-3 fa-fw" />
                          <div className="form-outline flex-fill mb-0">
                        ...
                        <div className="d-flex flex-row align-items-center mb-4">
                          <FontAwesomeIcon icon='fas fa-lock' className=" fa-lg me-3 fa-fw" />
                          <div className="form-outline flex-fill mb-0">
                        ...
                        <div className="d-flex flex-row align-items-center mb-4">
                          <FontAwesomeIcon icon='fas fa-key' className=" fa-lg me-3 fa-fw" />
                          <div className="form-outline flex-fill mb-0">
